...
import { technicianAcceptJobRequest } from '../../api';
...
export default function JobDetails() {
    ...
    const finishJob = () => navigate("/TechnicianDashboard", { state: { id } })
    return (
        <div>
            <Banner />
            <Card sx={{ minWidth: 275, display: "flex", flexDirection: "column", alignItems: "center" }}>
                ...
                </CardContent>
                {
                    flag ?
                        <CardActions>
                            <Button size="small" color='success' onClick={finishJob}>Finish Job</Button>
                        </CardActions>
                        :
                        <CardActions>
